...
const ThreeDGenerator = () => {
  ...
  useEffect(() => {
    if (gradioContainerRef.current) {
      ...
      // Use gradio-app to embed the Space
      const gradioElement = document.createElement('gradio-app');
      gradioElement.setAttribute('src', 'https://trellis-community-trellis.hf.space');
  ...
  return (
    <div className="flex flex-col space-y-8">
      ...
      <div className="text-sm text-foreground/60">
        Having trouble? Try opening the generator directly: {" "}
        <a
          ...
          className="underline"
        >
          trellis-community / TRELLIS Space
        </a>
      </div>

      {/* Load Gradio web component */}
      <script
        type="module"
